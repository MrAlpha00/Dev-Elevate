...
const ContributorGuide: React.FC = () => {
  ...
  // FAQs
  const faqs: FAQ[] = [
    { question: "What is a fork?", answer: "A fork is your personal copy of the elevora-ai repository where you can safely make changes." },
    { question: "What is a pull request?", answer: "A pull request is a request to merge your changes from your branch/fork into the main elevora-ai repository." },
  ...
  const contributionTypes: ContributionType[] = [
    ...
    { title: "Documentation", description: "Improve README, add examples, or clarify instructions for contributors.", example: "Example: Add step-by-step setup instructions with screenshots for elevora-ai." },
  ...
  return (
    <div className="min-h-screen px-4 py-12 mx-auto space-y-16 max-w-7xl bg-gray-50 dark:bg-black sm:px-6 lg:px-12">
      ...
      >
        <h2 className="mb-4 text-3xl font-bold text-center text-indigo-700 dark:text-indigo-400">🌟 About elevora-ai</h2>
        <p className="mb-12 text-lg leading-relaxed text-center text-gray-700 dark:text-gray-300">
          elevora-ai is an open-source platform for developers to contribute, learn, and grow by collaborating on real-world projects. Perfect for first-time contributors!
        </p>
      ...
      <div className="grid gap-8 mt-12 md:grid-cols-2">
        <WideCard icon={<Users className="w-8 h-8 text-indigo-600 dark:text-indigo-400" />} title="Getting Started" items={["Sign up on elevora-ai platform", "Choose a project that excites you", "Engage with mentors and contributors", "Kickstart with beginner issues"]} gradientFrom="from-blue-50" gradientTo="to-indigo-50" hoverFrom="blue-400" hoverTo="blue-500" />
