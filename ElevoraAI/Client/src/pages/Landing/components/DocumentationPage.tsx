    ...
    <div className="relative min-h-screen py-24 overflow-hidden bg-gradient-to-b from-gray-900 to-black">
      ...
      >
        ...
        <p className="mb-4 text-sm leading-relaxed text-gray-600 dark:text-gray-400">
          Elevora AI follows a modular monorepo structure with separate frontend
...
npm run dev   # Runs on http://localhost:5173`}
      ...
      >
        ...
        <p className="mb-4 text-sm leading-relaxed text-gray-600 dark:text-gray-400">
          Elevora AI welcomes contributions via GSSoC 2025! Follow strict
