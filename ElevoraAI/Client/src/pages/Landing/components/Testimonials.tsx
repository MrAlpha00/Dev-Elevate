  ...
  const staticTestimonials: Testimonial[] = [
    {
      ...
      content:
        'Elevora AI transformed my career. The AI study buddy helped me master DSA, and I landed my dream job at Google within 6 months!',
      rating: 5,
    },
    {
      name: 'Alex Rodriguez',
      ...
      content:
        'The personalized learning paths and mock interviews were game-changers. Elevora AI made complex concepts accessible and fun.',
      rating: 5,
    },
    {
      name: 'Priya Sharma',
    ...
    },
    {
      ...
      content:
        'Elevora AI’s system design modules and mentorship sessions were key to cracking Amazon’s rigorous interview process.',
      rating: 4,
    },
    {
      name: 'Emily Davis',
      ...
      <div className="relative z-10 px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="max-w-2xl mx-auto text-xl text-gray-400">
            Discover how <span className="font-semibold text-blue-400">Elevora AI</span> empowered developers to achieve their dream careers
          </p>
        </motion.div>
        ...
        <div className="relative z-10 max-w-5xl mx-auto mt-12 text-center">
          ...
          >
            ...
            <p className="mt-6 text-sm text-gray-400">
              ...
              <span className="font-semibold text-blue-400">Elevora AI</span>.
            </p>
          </motion.div>
        </div>
              ...
              <div className="relative z-10 w-full h-full">
                ...
                <div className="pt-4 mb-8 text-center">
                  ...
                  <p className="text-gray-300">
                    Help others by sharing how Elevora AI helped you in your journey
                  </p>
                </div>
                ...
                <form onSubmit={handleSubmit} noValidate className="space-y-6">
                  ...
                  <div>
                    <label htmlFor="likedMost" className="block mb-2 text-sm font-medium text-gray-200">
                      What did you like most about Elevora AI? *
                    </label>
                    <textarea
                      id="likedMost"
                      name="likedMost"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full px-4 py-3 text-gray-100 placeholder-gray-400 transition-all border rounded-lg border-gray-600/30 bg-gray-800/40 backdrop-blur-md focus:ring-2 focus:ring-blue-400/50 focus:border-blue-400/50 resize-vertical custom-scrollbar"
                      placeholder="Share how Elevora AI improved your learning journey..."
                    />
                  </div>
                  <div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <label htmlFor="canShow" className="text-sm text-gray-200">
                      I allow Elevora AI to display this testimonial publicly
                    </label>
                  </div>
                  {formData.canShow && (
                    <div>
