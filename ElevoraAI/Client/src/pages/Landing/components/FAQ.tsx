...
const FAQ: React.FC = () => {
  ...
  const faqs = [
    {
      question: "What is Elevora AI?",
      answer:
        "Elevora AI is your all-in-one platform for learning, coding practice, interview prep, resume building, tech news, and community support.",
    },
    {
      question: "Is Elevora AI free to use?",
      answer:
    ...
    <section className="relative py-20" id="faq">
      ...
      <div className="container px-4 mx-auto max-w-6xl">
        ...
        <p className="mx-auto mt-3 max-w-2xl text-center text-gray-300">
          Find answers to common questions about Elevora AI
        </p>
        ...
        <div className="grid gap-4 mt-10 md:grid-cols-2">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className={`rounded-xl border transition-all duration-200 bg-gray-900/60 border-white/10 shadow-lg ${activeIndex === index ? "ring-1 ring-indigo-500/50" : ""
                }`}
            >
              <button
                type="button"
              ...
              >
                ...
                <span
                  className={`shrink-0 rounded-md border border-white/10 p-1 text-indigo-400 transition-transform ${activeIndex === index ? "rotate-45" : ""
                    }`}
                  aria-hidden
                >
                  <svg
              ...
              <div
                className={`px-4 overflow-hidden transition-[max-height,padding] duration-300 ${activeIndex === index ? "max-h-40 pb-4" : "max-h-0"
                  }`}
              >
