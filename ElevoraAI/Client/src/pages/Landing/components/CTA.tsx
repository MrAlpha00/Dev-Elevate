...
const socials = [
  {
    ...
    url: "https://www.reddit.com/r/ElevoraAI",
    description:
    ...
    <>
      ...
      <div className="relative min-h-screen py-24 overflow-hidden bg-gradient-to-b from-gray-900 to-black">
        ...
        <div className="relative z-10 px-4 mx-auto text-center max-w-7xl">
          ...
          >
            Join our community of developers, share best practices, and get support for your learning journey with Elevora AI.
          </motion.p>
          ...
          >
            ...
            <p className="max-w-2xl mx-auto mb-8 text-lg text-gray-300">
              Join 100+ developers who are already learning, growing, and landing their dream jobs with Elevora AI's AI-powered platform.
            </p>
            ...
            <div className="flex flex-col justify-center gap-4 mb-8 sm:flex-row">
              ...
              <a
                href="mailto:officialElevoraAI@gmail.com?subject=Book%20a%20Demo"
