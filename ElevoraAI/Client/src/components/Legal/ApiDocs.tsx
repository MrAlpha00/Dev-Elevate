        ...
        <div className="px-4 py-8 min-h-screen text-gray-900 bg-gray-50 dark:bg-gray-900 dark:text-gray-100 sm:px-6 sm:py-16">
            ...
            <section className="mb-12 text-center sm:mb-16">
                ...
                <p className="mx-auto max-w-3xl text-base leading-relaxed text-gray-600 dark:text-gray-400 sm:text-lg">
                    Comprehensive RESTful APIs for authentication, user management, community features, ATS scanning, admin controls, and notifications in the ElevoraAI platform.
                </p>
            </section>
            ...
            <footer className="pt-6 mt-8 text-center text-gray-600 border-t dark:text-gray-400 border-gray-200/50 dark:border-gray-700/50">
                <p className="text-sm">
                    All requests require proper authentication where specified. Base URL: <code className="px-2 py-1 font-mono text-indigo-900 bg-gray-100 rounded dark:bg-gray-800 dark:text-indigo-300">https://elevora-ai-backend.onrender.com</code>
                </p>
            </footer>
        </div>
    );
