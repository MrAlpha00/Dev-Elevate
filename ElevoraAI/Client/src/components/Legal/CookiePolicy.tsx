...
const CookiePolicy: React.FC = () => {
  ...
  return (
    <div
      className={`min-h-screen transition-colors duration-200 ${state.darkMode ? "bg-gray-900" : "bg-gray-50"
        }`}
    >
      <div className="px-4 py-12 mx-auto max-w-4xl sm:px-6 lg:px-8">
        ...
        <div className="mb-12 text-center">
          ...
          >
            Learn how we use cookies to enhance your experience on Elevora AI
        ...
        >
          ...
          >
            At Elevora AI, we believe in being transparent about how we use
              ...
              >
                ...
                <ul className="space-y-3">
                  {section.content.map((item, itemIndex) => (
                    <li
                      key={itemIndex}
                      className={`flex items-start ${state.darkMode ? "text-gray-300" : "text-gray-700"
                        }`}
                    >
        ...
        >
          ...
          <p
            className={`mb-6 ${state.darkMode ? "text-gray-300" : "text-gray-700"
              }`}
          >
          ...
          <div
            className={`space-y-2 ${state.darkMode ? "text-gray-300" : "text-gray-700"
              }`}
          >
            <p>
