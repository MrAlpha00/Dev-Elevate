...
const TermsOfService: React.FC = () => {
  ...
  const sections = [
    {
      ...
      content: [
        "By accessing and using Elevora AI, you accept and agree to be bound by these Terms of Service",
    ...
    },
    {
      ...
      content: [
        ...
        "Commercial use requires explicit written permission from Elevora AI",
      ],
    },
    {
      icon: FileText,
      ...
      content: [
        ...
        "Our AI-generated content and platform features are proprietary to Elevora AI",
  ...
  return (
    <div
      className={`min-h-screen ${state.darkMode ? "bg-gray-900" : "bg-gray-50"
    ...
    >
      <div className="px-4 py-12 mx-auto max-w-4xl sm:px-6 lg:px-8">
        ...
        <div className="mb-12 text-center">
          ...
          <h1
            className={`text-4xl font-bold mb-4 ${state.darkMode ? "text-white" : "text-gray-900"
              }`}
          >
            Terms of Service
          </h1>
          ...
          >
            Please read these terms carefully before using Elevora AI. They
            govern your use of our platform and services.
          </p>
          <div
            className={`mt-4 text-sm ${state.darkMode ? "text-gray-400" : "text-gray-500"
              }`}
          >
        ...
        >
          ...
          >
            Welcome to Elevora AI
          </h2>
          <p
            className={`text-lg leading-relaxed ${state.darkMode ? "text-gray-300" : "text-gray-700"
              }`}
          >
            These Terms of Service ("Terms") govern your use of Elevora AI, an
            ...
            Elevora AI is designed to help students, developers, and
        ...
        >
          <h3
            className={`text-xl font-bold mb-4 ${state.darkMode ? "text-white" : "text-gray-900"
              }`}
          >
            Account Termination
          </h3>
          <p
            className={`mb-4 ${state.darkMode ? "text-gray-300" : "text-gray-700"
              }`}
          >
        ...
        >
          ...
          >
            <p>
              Elevora AI is provided "as is" without warranties of any kind. We
              do not guarantee that the platform will meet your specific
              requirements or that it will be error-free, secure, or
              continuously available.
            </p>
            <p>
              To the maximum extent permitted by law, Elevora AI shall not be
        ...
        >
          ...
          <div className="space-y-2">
            ...
            >
              <strong>Email:</strong> officialelevoraai@gmail.com
            </p>
            <p
              className={`${state.darkMode ? "text-gray-300" : "text-gray-700"
                }`}
