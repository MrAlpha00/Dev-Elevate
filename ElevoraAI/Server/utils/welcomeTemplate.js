    ...
    <div style="max-width: 620px; margin: auto; background-color: #ffffff; border-radius: 16px; padding: 40px; box-shadow: 0 10px 30px rgba(0,0,0,0.08);">
      ...
      <div style="text-align: center;">
        ...
        <p style="font-size: 16px; color: #444; line-height: 1.6;">
          You’ve officially joined <strong>Elevora AI</strong> — your all-in-one platform to boost your career, level up your coding skills, and connect with fellow developers.
        </p>
      </div>

      <div style="text-align: center; margin: 30px 0;">
        <a href="https://ElevoraAI-ai.vercel.app/" style="background: linear-gradient(to right, #6366f1, #4f46e5); color: #ffffff; padding: 14px 28px; text-decoration: none; border-radius: 10px; font-size: 16px; font-weight: 600; display: inline-block;">
      ...
      <div style="margin-top: 40px; font-size: 14px; color: #555;">
        <p>If you need any help, reply to this email or contact us at 
          <a href="mailto:officialElevoraAI@gmail.com" style="color: #4f46e5; font-weight: 500;">officialElevoraAI@gmail.com</a>
        </p>
        <hr style="margin: 30px 0; border: none; border-top: 1px solid #ddd;" />
        <p style="text-align: center;">
          🌐 <a href="https://ElevoraAI-ai.vercel.app/" style="color: #4f46e5; text-decoration: none;">https://ElevoraAI.in</a>  
        </p>
      </div>
    </div>
  </div>
